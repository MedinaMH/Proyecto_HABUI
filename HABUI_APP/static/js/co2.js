...
function lineChartCO2(containerId) {
    ...
    function redraw() {
        ...
        points.enter()
            ...
            .attr("r", 4)
            .attr("fill", d => {
                if (d.value < 800) return "#4caf50";
                if (d.value < 1200) return "#ffc107";
                return "#f44336";
            })
            .attr("stroke", "#ffffff")
            ...
            .on("mouseover", function(event, d) {
                ...
                const nivelTexto = d.value < 800 ? "BUENO" : d.value < 1200 ? "MODERADO" : "ALTO";
                const nivelColor = d.value < 800 ? "#4caf50" : d.value < 1200 ? "#ffc107" : "#f44336";

                tooltip
                    .html(`
                        <div style="display: flex; align-items: center; margin-bottom: 6px;">
                            <div style="width: 12px; height: 12px; background: ${nivelColor}; border-radius: 50%; margin-right: 8px;"></div>
                            <strong style="font-size: 16px; color: #ffb74d;">${Math.round(d.value)} ppm</strong>
                        </div>
                        ...
                        ${d.value >= 1200 ? '<div style="margin-top: 8px; padding: 4px 8px; background: rgba(244, 67, 54, 0.1); border-radius: 4px; font-size: 10px; color: #f44336;">Se recomienda ventilación</div>' : ''}
                    `)
